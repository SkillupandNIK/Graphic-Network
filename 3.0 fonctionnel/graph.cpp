...
//    add_interfaced_vertex(7,  0.0, 500, 500, "bad_clowns_xx3xx.jpg", 2);
    ...
    add_interfaced_vertex(0, 10, 200, 100, yoyo);
    add_interfaced_vertex(1, 30, 400, 100, "Poule.bmp");
    add_interfaced_vertex(2, 15, 200, 300, "Cochon.bmp");
    add_interfaced_vertex(3, 20, 400, 300, "Renard.bmp");
    add_interfaced_vertex(4, 500, 600, 300, "Eau.bmp");
    add_interfaced_vertex(5, 500, 100, 500, "Graine.bmp");
...
//        std::cout << "OUT : Tour n" << i << std::endl;
//        std::cout << "OUT size : " << remver.m_out.size() << std::endl;
//    }
